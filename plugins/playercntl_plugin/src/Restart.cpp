...
#include <FLCoreServer.h>
    ...
    bool Restart::UserCmd_ShowRestarts(
    ...
    bool Restart::UserCmd_Restart(uint iClientID, const std::wstring &wscCmd,
        ...
        if (set_iMaxRank != 0) {
            ...
            if (iRank == 0 || iRank > set_iMaxRank) {
                PrintUserCmdText(iClientID,
                                 L"ERR You must create a new char to restart. "
                                 L"Your rank is too high");
                return true;
            }
        }
        ...
        if (acc) {
            ...
            HkKickReason(restart.wscCharname,
                         L"Updating character, please wait 10 seconds before "
                         L"reconnecting");
        }
        return true;
    }
